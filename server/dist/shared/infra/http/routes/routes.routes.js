...
var _ListRoutesByNeighborhoodController = require("../../../../modules/routes/useCases/listRoutesByNeighborhood/ListRoutesByNeighborhoodController");
...
routesRoutes.get("/neighborhood", _ensureAuthenticated.default, listRoutesByNeighborhoodController.handle);
...
routesRoutes.patch("/", _ensureAuthenticated.default, updateRouteController.handle);
routesRoutes.delete("/", _ensureAuthenticated.default, deleteRouteController.handle);